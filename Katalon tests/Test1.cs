...
namespace SeleniumTests
{
    ...
    public class Test1
    {
        ...
        public void The1Test()
        {
            ...
            try
            {
                Assert.AreEqual("15", driver.FindElement(By.Name("age")).GetAttribute("value"));
            }
            catch (AssertionException e)
            {
                verificationErrors.Append(e.Message);
            ...
            driver.FindElement(By.XPath("//div[@id='body']/section[2]")).Click();
            driver.FindElement(By.XPath("//div[@id='body']/section[2]")).Click();
            // ERROR: Caught exception [ERROR: Unsupported command [doubleClick | //div[@id='body']/section[2] | ]]
            driver.FindElement(By.XPath("//div[@id='body']/section[2]")).Click();
            try
            {
