...
namespace SeleniumTests
{
    ...
    public class Test4
    {
        ...
        public void The4Test()
        {
            ...
            Assert.AreEqual("52", driver.FindElement(By.Name("age")).GetAttribute("value"));
            driver.FindElement(By.Id("body")).Click();
            Assert.AreEqual("Your Premium is 0.75", driver.FindElement(By.XPath("//div[@id='body']/section[2]/b")).Text);
        }
